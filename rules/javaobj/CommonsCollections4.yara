rule M_Methodology_HTTP_SerializedObject_JavaObj_CommonsCollections4_base64 {
	meta:
		author="Alyssa Rahman @ramen0x3f - heyserial.py"
		description="Auto-generated rule for serialized objects with the keyword/chain: commonscollections4javautilpriorityqueueorgapachecommonscollections4comparatorstransformingcomparatorcomparablecomparatorchainedtransformer"
	strings:
		$objheader="rO"
...
rule M_Methodology_HTTP_SerializedObject_JavaObj_CommonsCollections4_raw {
	meta:
		author="Alyssa Rahman @ramen0x3f - heyserial.py"
		description="Auto-generated rule for serialized objects with the keyword/chain: commonscollections4javautilpriorityqueueorgapachecommonscollections4comparatorstransformingcomparatorcomparablecomparatorchainedtransformer"
	strings:
